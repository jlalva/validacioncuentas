...
class backupModelo extends Model{
    ...
    protected $allowedFields = ['bac_nombre', 'bac_tamanio', 'bac_fecha', 'bac_usu_id', 'bac_estado'];

    public function reads(){
        $query = $this->query("SELECT bac_id,bac_nombre,bac_tamanio,DATE_FORMAT(bac_fecha,'%d-%m-%Y %H:%i') as fecha,usu_usuario
        FROM `backup` bac 
