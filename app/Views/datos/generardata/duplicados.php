...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    <h6 class="mb-0 text-uppercase">Cuentas Duplicadas</h6>
    <div class="ms-auto">
        <div class="btn-group">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="editarduplicado()">Editar</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function datoseditarduplicado(id,correo,dominio){
        $("#correogenerado").val(correo)
        $("#dominio").val(dominio)
        $("#iddato").val(id)
    }

    function editarduplicado(){
        alertify.dismissAll();
