...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-10">
                <h6 class="mb-0 text-uppercase">Agregar Dominio</h6>
            </div>
            <div class="col-md-2" style="text-align: right;">
                <a href="<?=base_url('dominio')?>" class="btn btn-warning btn-sm" style="color: #000;margin-top:-7px;"><i class="fa fa-remove"></i> Cancelar </a>
                <?php if (agregar()) { ?>
