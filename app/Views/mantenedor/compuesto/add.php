...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-10">
                <h6 class="mb-0 text-uppercase">Agregar No Compuesto</h6>
            </div>
            <div class="col-md-2" style="text-align: right;">
                <a href="<?=base_url('compuesto')?>" class="btn btn-warning btn-sm" style="color: #000;margin-top:-7px;"><i class="fa fa-remove"></i> Cancelar </a>
                <?php if (agregar()) { ?>
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <input type="text" class="form-control" id="compuesto" name="compuesto" autocomplete="off" oninput="this.value = this.value.toUpperCase()">
            </div>
                ...
                $.ajax({
                    ...
                    success: function(result){
                        if(result == 1){
                            ...
                            if(result = 'duplicado'){
                                alertify.error("El compuesto ingresado ya existe");
                            }else{
